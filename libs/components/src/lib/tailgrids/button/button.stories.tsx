...
export const WithGiftIcon: Story = {
  render: () => {
    ...
    return (
      <div className="flex flex-col gap-4">
        <TGButton variant="primary" icon={GiftIconSVG} iconPosition="left" size="lg">
          OK
        </TGButton>
        <TGButton variant="outline" icon={GiftIconSVG} iconPosition="left" size="lg">
          OK
        </TGButton>
        <TGButton variant="ghost" icon={GiftIconSVG} iconPosition="left" size="lg">
          OK
        </TGButton>
        <TGButton variant="primary" icon={GiftIconSVG} iconPosition="left" size="lg" disabled>
          OK
        </TGButton>
      </div>
    );
